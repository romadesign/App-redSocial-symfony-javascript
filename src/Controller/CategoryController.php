...
class CategoryController extends AbstractController
{
  ...
  {
    $entityManager = $doctrine->getManager();
    $categorie = $entityManager->getRepository(Category::class)->getPostPublic($id);
    $categorie_name = $entityManager->getRepository(Category::class)->find($id);


    if ($categorie != null) {
      $posts = $categorie;
      $title = $categorie_name->getName();
    } else {
